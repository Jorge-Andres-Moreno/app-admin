...
public class AgentAssign {
    ...
    public static AgentAssign getInstance() {
        return INSTANCE;
    }
    ...
    public void assign(final DefaultCallback callback) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                try {
                    ...
                    RequestBody body = new FormBody.Builder()
                            .add("profesional", selectProfessional.getUID())
                            .add("paciente", selectPatient.getUID())
                            .build();

                    Request request = new Request.Builder()
                            .url(NetworkConstants.URL + NetworkConstants.PATH_ASSIGN)
                            .post(body)
                            .build();
